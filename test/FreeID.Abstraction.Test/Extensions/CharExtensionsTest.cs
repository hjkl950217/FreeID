...
namespace FreeID.Abstraction.Test.Extensions
{
    public class CharExtensionsTest
    {
        public class ToBinString
        {
            ...
            public void ToBitString_NoError(char source, string expected)
            {
        ...
        public class ToOctString
        {
            ...
            public void ToOct_NoError(char source, string expected)
            {
        ...
        public class ToDecString
        {
            ...
            public void ToDecString_NoError(char source, string expected)
            {
        ...
        public class ToHexString
        {
            ...
            public void ToHexString_NoError(char source, string expected)
            {
