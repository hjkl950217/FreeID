...
namespace FreeID.Abstraction.Test.Extensions
{
    public class ShortExtensionsTest
    {
        public class ToBinString
        {
            ...
            public void ToBitString_NoError(short source, string expected)
            {
        ...
        public class ToOctString
        {
            ...
            public void ToOct_NoError(short source, string expected)
            {
        ...
        public class ToDecString
        {
            ...
            public void ToDecString_NoError(short source, string expected)
            {
        ...
        public class ToHexString
        {
            ...
            public void ToHexString_NoError(short source, string expected)
            {
