...
namespace FreeID.Abstraction.Test.Extensions
{
    public class LongExtensionsTest
    {
        public class ToBinString
        {
            ...
            public void ToBitString_NoError(long source, string expected)
            {
        ...
        public class ToOctString
        {
            ...
            public void ToOct_NoError(long source, string expected)
            {
        ...
        public class ToDecString
        {
            ...
            public void ToDecString_NoError(long source, string expected)
            {
        ...
        public class ToHexString
        {
            ...
            public void ToHexString_NoError(long source, string expected)
            {
