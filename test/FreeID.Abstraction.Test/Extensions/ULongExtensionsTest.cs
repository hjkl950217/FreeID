...
{
    public class ULongExtensionsTest
    {
        public class ToBinString
        {
            ...
            public void ToBitString_NoError(ulong source, string expected)
            {
        ...
        public class ToOctString
        {
            ...
            public void ToOct_NoError(ulong source, string expected)
            {
        ...
        public class ToDecString
        {
            ...
            public void ToDecString_NoError(ulong source, string expected)
            {
        ...
        public class ToHexString
        {
            ...
            public void ToHexString_NoError(ulong source, string expected)
            {
