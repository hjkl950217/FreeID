...
{
    public class UShortExtensionsTest
    {
        public class ToBinString
        {
            ...
            public void ToBitString_NoError(ushort source, string expected)
            {
        ...
        public class ToOctString
        {
            ...
            public void ToOct_NoError(ushort source, string expected)
            {
        ...
        public class ToDecString
        {
            ...
            public void ToDecString_NoError(ushort source, string expected)
            {
        ...
        public class ToHexString
        {
            ...
            public void ToHexString_NoError(ushort source, string expected)
            {
