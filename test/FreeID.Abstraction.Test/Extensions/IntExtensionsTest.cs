...
namespace FreeID.Abstraction.Test.Extensions
{
    public class IntExtensionsTest
    {
        public class ToBinString
        {
            ...
            public void ToBitString_NoError(int source, string expected)
            {
        ...
        public class ToOctString
        {
            ...
            public void ToOct_NoError(int source, string expected)
            {
        ...
        public class ToDecString
        {
            ...
            public void ToDecString_NoError(int source, string expected)
            {
        ...
        public class ToHexString
        {
            ...
            public void ToHexString_NoError(int source, string expected)
            {
